...
// --- BRAND ASSETS ---
export const LogoIcon: React.FC<IconProps> = ({ className = "w-9 h-9", ...props }) => (
  <svg
    ...
    {...props}
  >
    {/* A bold and dynamic logo representing a crystalline or multifaceted 'Z'. 
        It conveys strength, precision, and the AI's ability to analyze from different angles. 
        The sharp, geometric form is memorable and suggests cutting-edge technology. */}
    <path d="M21 3 10 14" />
    <path d="M3 21l11-11" />
    <path d="M21 3H3" />
    <path d="M3 21h18" />
...
export const LogoWordmark: React.FC<IconProps> = ({ className = 'h-6', ...props }) => (
  <svg viewBox="0 0 120 24" fill="currentColor" className={className} {...props}>
    <text x="0" y="18" fontFamily="Inter, sans-serif" fontSize="20" fontWeight="bold">
      Zewail
      <tspan fillOpacity="0.7"> AI</tspan>
    </text>
  </svg>
);


// --- UI ICONS (Outline Style) ---
...
export const LightBulbIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 14.25h3m-3 0V12a2.25 2.25 0 0 1 2.25-2.25m0 0V9.75M12 12v2.25m-3-4.5v-1.5a3.375 3.375 0 0 1 6.75 0v1.5m-6.75 0h6.75a2.25 2.25 0 0 1 2.25 2.25v3.75a2.25 2.25 0 0 1-2.25 2.25h-6.75a2.25 2.25 0 0 1-2.25-2.25v-3.75a2.25 2.25 0 0 1 2.25-2.25Z" />
  </svg>
);
...
export const BoltIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
...
export const PanelLeftCloseIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
...
export const PanelLeftOpenIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
export const ArrowLeftOnRectangleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
...
export const PaintBrushIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-4.242 0c-1.172 1.172-1.172 3.07 0 4.242.943.944 2.51.944 3.454 0l10.24-10.24-4.24-4.24-5.758 5.757Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.623 12.377a2.25 2.25 0 0 1 3.184 0l2.25 2.25a2.25 2.25 0 0 1 0 3.184l-2.25 2.25a2.25 2.25 0 0 1-3.184 0l-2.25-2.25a2.25 2.25 0 0 1 0-3.184l2.25-2.25Z" />
  </svg>
);

export const PaperClipIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3.375 3.375 0 1 1 18.374 9.5l-9.19 9.19a1.125 1.125 0 0 1-1.59-1.591l6.344-6.344" />
  </svg>
);
...
export const ComputerDesktopIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
...
export const NewspaperIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" />
    </svg>
);

export const StopCircleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className} {...props}>
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 0a9.006 9.006 0 0 0 3.75 7.5m12.75-7.5a9.006 9.006 0 0 1-3.75 7.5m-9-15a9.006 9.006 0 0 1 3.75-1.5m3 1.5a9.006 9.006 0 0 0-3.75-1.5m0 0v1.5m0-1.5v-1.5" />
  </svg>
);

export const EnvelopeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
...
export const ThumbsUpIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 0 1 2.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 0 0 .322-1.672V2.75a.75.75 0 0 1 .75-.75 2.25 2.25 0 0 1 2.25 2.25c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 0 1-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 0 0-1.423-.23H5.904M6.633 10.25l-2.286-6.857a.75.75 0 0 0-.75-.5_2.25 2.25 0 0 0-2.25 2.25v6.75c0 .621.504 1.125 1.125 1.125h3.383c.377 0 .723.242.853.604l.333 1.116c.386.77.283 1.67-.28 2.302a4.5 4.5 0 0 0-2.302 2.82V21a.75.75 0 0 0 .75.75H6.633c.597 0 1.168-.24 1.594-.652a4.5 4.5 0 0 0 1.125-2.903l.058-1.039a5.625 5.625 0 0 1 .34-1.476l.34-1.476a4.5 4.5 0 0 0-1.423-.23Z" />
    </svg>
);

export const ThumbsDownIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.806 0 1.533.446 2.031 1.08a9.041 9.041 0 0 0 2.861 2.4c.723.384 1.35.956 1.653 1.715a4.498 4.498 0 0 1 .322 1.672V21.25a.75.75 0 0 0 .75.75 2.25 2.25 0 0 0 2.25-2.25c0-1.152-.26-2.243-.723-3.218-.266-.558.107-1.282.725-1.282h3.126c1.026 0 1.945-.694 2.054-1.715.045-.422.068.85.068-1.285a11.95 11.95 0 0 0-2.649-7.521c-.388-.482-.987-.729-1.605-.729H13.48c-.483 0-.964.078-1.423-.23l-3.114 1.04a4.501 4.501 0 0 1-1.423.23H5.904M6.633 10.25l-2.286 6.857a.75.75 0 0 1-.75.5 2.25 2.25 0 0 1-2.25-2.25v-6.75c0-.621.504-1.125 1.125-1.125h3.383c.377 0 .723-.242.853-.604l.333-1.116c.386-.77.283-1.67-.28-2.302a4.5 4.5 0 0 1-2.302-2.82V3a.75.75 0 0 1 .75-.75H6.633c.597 0 1.168-.24 1.594-.652a4.5 4.5 0 0 1 1.125 2.903l.058 1.039a5.625 5.625 0 0 0 .34 1.476l.34 1.476a4.5 4.5 0 0 1-1.423.23Z" />
    </svg>
);

export const ArrowUpOnSquareIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15M9 12l3 3m0 0 3-3m-3 3V2.25" />
    </svg>
);

export const CpuChipIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M8.25 21v-1.5M21 15.75h-1.5M15.75 3v1.5M15.75 21v-1.5m5.25-11.25h-1.5M3.75 3.75h16.5v16.5H3.75V3.75Z" />
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.75 7.5h16.5M5.625 7.5V5.625a2.25 2.25 0 0 1 2.25-2.25h8.25a2.25 2.25 0 0 1 2.25 2.25v1.875" />
    </svg>
);

export const AcademicCapIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.25L3 7.5l9-4.5 9 4.5-9 3.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5v6c0 2.25 3.375 4.5 9 4.5s9-2.25 9-4.5v-6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 10.5v.75" />
    </svg>
);
